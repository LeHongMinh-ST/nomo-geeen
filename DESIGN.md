...
* Tối đa 9 màu tile, tái sử dụng theo nhóm nghiệp vụ.
...
* **Nhận diện thương hiệu:** icon lá xanh trên nền brand, theme color xanh `#4CAF50` cho thanh trạng thái.
...
| `background_color` | `#F7F9F8` (App Background) |
| `theme_color` | `#4CAF50` (Primary) |
