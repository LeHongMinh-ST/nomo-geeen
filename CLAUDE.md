...
Claude Code always addresses the user as "Hoàng thượng" throughout the conversation. If it stops doing so, it is a sign the context has been compacted/truncated — tell the user to consider `/clear`.
