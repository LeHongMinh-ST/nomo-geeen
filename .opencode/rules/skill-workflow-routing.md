...
Use this rule instead of automatic prompt routing. Read the user's intent, choose the primary CafeKit workflow, then load the relevant `.opencode/skills/<skill>/SKILL.md`.
