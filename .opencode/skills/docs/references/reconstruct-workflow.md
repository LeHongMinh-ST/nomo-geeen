...
If the user provides a different docs root through `.opencode/runtime.json`, use that root.
...
```text
node .opencode/scripts/validate-docs-reconstruct.cjs docs/as-is/<scope-slug>
```
