...
For frontend issues, use `.opencode/references/debugger/frontend-verification.md`.
For CI/log issues, use `.opencode/references/debugger/log-ci-analysis.md`.
For performance issues, use `.opencode/references/debugger/performance-diagnostics.md`.
...
- For flaky async tests, use `.opencode/references/debugger/condition-based-waiting.md`.
...
- Side-effect sweep from `.opencode/references/debugger/side-effect-gate.md`
...
Load as needed:
- `.opencode/references/debugger/core-philosophy.md` - Anti-guessing discipline
- `.opencode/references/debugger/root-cause-tracing.md` - Backward trace to origin
- `.opencode/references/debugger/verification-protocol.md` - Fresh evidence requirements
- `.opencode/references/debugger/log-ci-analysis.md` - Logs and CI/CD failure analysis
- `.opencode/references/debugger/parallel-agent-hydration.md` - Parallel reconnaissance
- `.opencode/references/debugger/frontend-verification.md` - Browser/UI verification
- `.opencode/references/debugger/performance-diagnostics.md` - Performance investigation
- `.opencode/references/debugger/condition-based-waiting.md` - Flaky async test diagnosis
- `.opencode/references/debugger/side-effect-gate.md` - Regression and blast-radius checks
