...
export const PRODUCT_KIND_CATALOG: readonly ProductKindDefinition[] = [
	...
	},
	{
		...
		requiredAttrs: ["activeIngredient", "concentration", "phiDays", "reiDays"],
		fields: [
			{ key: "activeIngredient", label: "Hoạt chất", input: "text" },
			{ key: "concentration", label: "Nồng độ / hàm lượng", input: "text" },
			{ key: "phiDays", label: "Thời gian cách ly (ngày)", input: "number" },
			{ key: "reiDays", label: "Thời gian tái nhập (ngày)", input: "number" },
		],
	},
	{
		id: "FERTILIZER",
	...
	{
		id: "BIOLOGICAL_PRODUCT",
		label: "Chế phẩm sinh học",
		businessGroup: "CROP_INPUTS",
		requiredAttrs: ["composition"],
		fields: COMMON_CROP_FIELDS,
	},
	{
		id: "GROWTH_REGULATOR",
		label: "Chất điều hòa sinh trưởng",
		businessGroup: "CROP_INPUTS",
		requiredAttrs: ["composition"],
		fields: COMMON_CROP_FIELDS,
	},
	...
	{
		id: "AGRI_MATERIAL",
		label: "Vật tư nông nghiệp khác",
		businessGroup: "CROP_INPUTS",
		requiredAttrs: [],
		fields: [{ key: "materialType", label: "Loại vật tư", input: "text" }],
	},
	{
		id: "CROP_SEED",
		...
		requiredAttrs: [],
		fields: [
			{ key: "species", label: "Loài cây", input: "text", optional: true },
			{ key: "variety", label: "Giống", input: "text", optional: true },
		],
	},
	{
		id: "SEED",
		label: "Hạt giống",
		businessGroup: "CROP_SEEDLINGS",
		requiredAttrs: ["species", "variety"],
		fields: [
			{ key: "species", label: "Loài cây", input: "text" },
			{ key: "variety", label: "Tên giống", input: "text" },
		],
	},
	{
		id: "SEEDLING",
	...
	},
	{
		...
		requiredAttrs: ["animalSpecies", "feedForm"],
		fields: [
			{ key: "animalSpecies", label: "Vật nuôi sử dụng", input: "text" },
			{ key: "feedForm", label: "Dạng thức ăn", input: "text" },
		],
	},
	{
		id: "VET_DRUG",
		...
		fields: [
			...
			{ key: "dosageForm", label: "Dạng bào chế", input: "text" },
			{
				...
				label: "Cách ly thịt (ngày)",
				input: "number",
			},
			{
				key: "withdrawalMilkDays",
				label: "Cách ly sữa (ngày)",
				input: "number",
			},
			{
				key: "withdrawalEggDays",
				label: "Cách ly trứng (ngày)",
				input: "number",
			},
		],
	},
	{
		...
		requiredAttrs: ["species", "breed"],
		fields: [
			{ key: "species", label: "Loài vật nuôi", input: "text" },
			{ key: "breed", label: "Giống", input: "text" },
		],
	},
];
...
export function normalizeProductAttrs(
	...
	return Object.fromEntries(
		fields
			...
			.map(([key, value]) => [
				key,
				fields.find((field) => field.key === key)?.input === "number"
					? Number(value)
					: value,
			]),
	);
