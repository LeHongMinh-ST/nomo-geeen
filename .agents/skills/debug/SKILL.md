...
For frontend issues, use `.Codex/references/debugger/frontend-verification.md`.
For CI/log issues, use `.Codex/references/debugger/log-ci-analysis.md`.
For performance issues, use `.Codex/references/debugger/performance-diagnostics.md`.
...
- For flaky async tests, use `.Codex/references/debugger/condition-based-waiting.md`.
...
- Side-effect sweep from `.Codex/references/debugger/side-effect-gate.md`
...
Load as needed:
- `.Codex/references/debugger/core-philosophy.md` - Anti-guessing discipline
- `.Codex/references/debugger/root-cause-tracing.md` - Backward trace to origin
- `.Codex/references/debugger/verification-protocol.md` - Fresh evidence requirements
- `.Codex/references/debugger/log-ci-analysis.md` - Logs and CI/CD failure analysis
- `.Codex/references/debugger/parallel-agent-hydration.md` - Parallel reconnaissance
- `.Codex/references/debugger/frontend-verification.md` - Browser/UI verification
- `.Codex/references/debugger/performance-diagnostics.md` - Performance investigation
- `.Codex/references/debugger/condition-based-waiting.md` - Flaky async test diagnosis
- `.Codex/references/debugger/side-effect-gate.md` - Regression and blast-radius checks
