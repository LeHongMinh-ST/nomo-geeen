...
1. Read the docs root from `.Codex/runtime.json`.
...
Read `.Codex/runtime.json` first. Use:
...
- use `.Codex/scripts/validate-docs.cjs <docs-root>` after create/update work
- use `.Codex/scripts/validate-docs-reconstruct.cjs <docs-root>/as-is/<scope-slug>` before a reconstructed bundle is handed to human review
