...
Once `repomix-output.xml` is generated, **DO NOT** attempt to read the entire file sequentially using the targeted file reads tool. It will overflow your Context Window instantly.
- Use `rg` to extract only the XML tags relevant to your current target.
