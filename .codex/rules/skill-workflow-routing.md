...
Use this rule instead of automatic prompt routing. Read the user's intent, choose the primary CafeKit workflow, then load the relevant `.agents/skills/<skill>/SKILL.md`.
...
Codex CLI selects skills from frontmatter descriptions; trust it for clear intents.
