...
- The `docs_keeper` agent should proactively scan for stale docs during weekly reviews

## When to Update

The `docs_keeper` agent is responsible for keeping these documents current. Trigger an update whenever:
