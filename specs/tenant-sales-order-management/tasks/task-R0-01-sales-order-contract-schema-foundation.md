...
- [ ] 1. Extend the Prisma sales contract and create the named migration.
...
- [ ] 2. Regenerate and validate the Prisma client.
...
- [ ] 3. Verify forward and application rollback compatibility.
...
- [ ] Prisma schema exposes nullable `Sale.note`, `SALE_CANCEL`, and the four-column index exactly once.
- [ ] Migration applies without rewriting or dropping existing data.
- [ ] Prisma generation and backend build pass with current quick-sale code.
- [ ] Runtime reachability is explicitly deferred to tasks R1-01, R2-01, and R3-01, which consume the schema through `SalesService`.
